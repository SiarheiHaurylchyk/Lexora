...
export function sanitizeLessonCallUrl(
 ...
 */
export function parseJitsiMeetConnection(
  url: string,
...
export function ensureJitsiExternalApiScript(
  meetingUrl: string,
): Promise<void> {
