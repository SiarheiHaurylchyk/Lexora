import type { LessonBlockType } from '../api/types';
...
export function normalizeMcq(raw: unknown): McqPayload {
  ...
  let correctIndex =
    typeof o.correctIndex === 'number' ? Math.floor(o.correctIndex) : 0;
...
export function normalizeFillBlank(raw: unknown): FillBlankPayload {
  ...
  const caseInsensitive =
    typeof o.caseInsensitive === 'boolean' ? o.caseInsensitive : true;
...
export function getDefaultLessonBlockContent(
