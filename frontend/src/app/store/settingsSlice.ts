...
export type { SettingsState, SpeechSettings } from '@/shared/types';
...
const settingsSlice = createSlice({
  ...
  reducers: {
    setLanguageVoice: (
      state,
      action: PayloadAction<{ lang: string; voiceURI: string }>,
    ) => {
...
export const { setLanguageVoice, setNormalRate, setSlowRate, resetSpeech } =
